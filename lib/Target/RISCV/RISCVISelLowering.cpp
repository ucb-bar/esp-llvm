...
static bool CC_RISCV(const DataLayout &DL, RISCVABI::ABI ABI, unsigned ValNo,
                     ...
                     bool IsRet, OpenCLLowering::ArgType OpenCLArgType, Type *OrigTy) {
  ...
  unsigned Reg;
  if (OpenCLArgType == OpenCLLowering::VSRREG)
...
void RISCVTargetLowering::analyzeInputArgs(
  ...
  for (unsigned i = 0; i != NumArgs; ++i) {
    ...
    if (CC_RISCV(MF.getDataLayout(), ABI, i, ArgVT, ArgVT, CCValAssign::Full,
                 ArgFlags, CCInfo, /*IsFixed=*/true, IsRet, OpenCLArgType, ArgTy)) {
...
void RISCVTargetLowering::analyzeOutputArgs(
  ...
  for (unsigned i = 0; i != NumArgs; i++) {
    ...
    RISCVABI::ABI ABI = MF.getSubtarget<RISCVSubtarget>().getTargetABI();
    if (CC_RISCV(MF.getDataLayout(), ABI, i, ArgVT, ArgVT, CCValAssign::Full,
                 ArgFlags, CCInfo, Outs[i].IsFixed, IsRet, OpenCLArgType, OrigTy)) {
...
const char *RISCVTargetLowering::getTargetNodeName(unsigned Opcode) const {
  ...
  //One would think all this could be autogenerated...
  case RISCVISD::CALLV:
    return "RISCVISD::CALLV";
  case RISCVISD::VSETCFG:
    return "RISCVISD::VSETCFG";
  case RISCVISD::VSETVL:
    return "RISCVISD::VSETVL";
  case RISCVISD::VLUI:
    return "RISCVISD::VLUI";
  case RISCVISD::VLI:
    return "RISCVISD::VLI";
  case RISCVISD::VADDI:
    return "RISCVISD::VADDI";
  case RISCVISD::HI32:
    return "RISCVISD::HI32";
  case RISCVISD::LO32:
    return "RISCVISD::LO32";
  }
  return nullptr;
}
