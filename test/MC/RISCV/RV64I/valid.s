...
# CHECK64: mv      x30, x0                 # encoding: [0xf0,0x00,0x00,0x13]
...
# CHECK64: seqz    x6, x0                  # encoding: [0x30,0x01,0x01,0x93]
...
# CHECK64: not     x10, x9                 # encoding: [0x52,0x7f,0x02,0x13]
...
# CHECK64: add     x16, x15, x14           # encoding: [0x83,0x9e,0x00,0x33]
# CHECK64: sub     x17, x16, x15           # encoding: [0x8b,0xe1,0x00,0x33]
# CHECK64: slt     x18, x17, x16           # encoding: [0x94,0x22,0x01,0x33]
# CHECK64: sltu    x19, x18, x17           # encoding: [0x9c,0x64,0x01,0xb3]
# CHECK64: and     x20, x19, x18           # encoding: [0xa4,0xa6,0x03,0xb3]
# CHECK64: or      x21, x20, x19           # encoding: [0xac,0xe8,0x03,0x33]
# CHECK64: xor     x22, x21, x20           # encoding: [0xb5,0x2a,0x02,0x33]
# CHECK64: sll     x23, x22, x21           # encoding: [0xbd,0x6d,0x00,0xb3]
# CHECK64: srl     x24, x23, x22           # encoding: [0xc5,0xae,0x02,0xb3]
# CHECK64: sra     x25, x24, x23           # encoding: [0xcd,0xf1,0x02,0xb3]
...
# CHECK64: mv      x31, x0                 # encoding: [0xf8,0x00,0x00,0x13]
...
# CHECK64: seqz    x7, x0                  # encoding: [0x38,0x01,0x01,0x93]
...
# CHECK64: not     x11, x10                # encoding: [0x5a,0xbf,0x02,0x13]
...
# CHECK64: sext.w	x6, x7             # encoding: [0x31,0xc0,0x00,0x1b]
