...
; CHECK-NEXT:    sw t0, 56(sp)
; CHECK-NEXT:    sw t1, 52(sp)
; CHECK-NEXT:    sw t2, 48(sp)
; CHECK-NEXT:    sw a0, 44(sp)
; CHECK-NEXT:    sw a1, 40(sp)
; CHECK-NEXT:    sw a2, 36(sp)
; CHECK-NEXT:    sw a3, 32(sp)
; CHECK-NEXT:    sw a4, 28(sp)
; CHECK-NEXT:    sw a5, 24(sp)
; CHECK-NEXT:    sw a6, 20(sp)
; CHECK-NEXT:    sw a7, 16(sp)
; CHECK-NEXT:    sw t3, 12(sp)
; CHECK-NEXT:    sw t4, 8(sp)
; CHECK-NEXT:    sw t5, 4(sp)
; CHECK-NEXT:    sw t6, 0(sp)
; CHECK-NEXT:    call callee_irq
; CHECK-NEXT:    lw t6, 0(sp)
; CHECK-NEXT:    lw t5, 4(sp)
; CHECK-NEXT:    lw t4, 8(sp)
; CHECK-NEXT:    lw t3, 12(sp)
; CHECK-NEXT:    lw a7, 16(sp)
; CHECK-NEXT:    lw a6, 20(sp)
; CHECK-NEXT:    lw a5, 24(sp)
; CHECK-NEXT:    lw a4, 28(sp)
; CHECK-NEXT:    lw a3, 32(sp)
; CHECK-NEXT:    lw a2, 36(sp)
; CHECK-NEXT:    lw a1, 40(sp)
; CHECK-NEXT:    lw a0, 44(sp)
; CHECK-NEXT:    lw t2, 48(sp)
; CHECK-NEXT:    lw t1, 52(sp)
