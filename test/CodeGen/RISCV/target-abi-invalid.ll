...
; RV32I-FOO-LABEL: nothing:
; RV32I-FOO:       # %bb.0:
; RV32I-FOO-NEXT:    ret
;
; RV32IF-ILP32FOOF-LABEL: nothing:
; RV32IF-ILP32FOOF:       # %bb.0:
; RV32IF-ILP32FOOF-NEXT:    ret
;
; RV64I-ILP32-LABEL: nothing:
; RV64I-ILP32:       # %bb.0:
; RV64I-ILP32-NEXT:    ret
;
; RV64IF-ILP32F-LABEL: nothing:
; RV64IF-ILP32F:       # %bb.0:
; RV64IF-ILP32F-NEXT:    ret
;
; RV64IFD-ILP32D-LABEL: nothing:
; RV64IFD-ILP32D:       # %bb.0:
; RV64IFD-ILP32D-NEXT:    ret
;
; RV64I-ILP32E-LABEL: nothing:
; RV64I-ILP32E:       # %bb.0:
; RV64I-ILP32E-NEXT:    ret
;
; RV32I-LP64-LABEL: nothing:
; RV32I-LP64:       # %bb.0:
; RV32I-LP64-NEXT:    ret
;
; RV32IF-LP64F-LABEL: nothing:
; RV32IF-LP64F:       # %bb.0:
; RV32IF-LP64F-NEXT:    ret
;
; RV32IFD-LP64D-LABEL: nothing:
; RV32IFD-LP64D:       # %bb.0:
; RV32IFD-LP64D-NEXT:    ret
;
; RV32I-ILP32F-LABEL: nothing:
; RV32I-ILP32F:       # %bb.0:
; RV32I-ILP32F-NEXT:    ret
;
; RV64I-LP64F-LABEL: nothing:
; RV64I-LP64F:       # %bb.0:
; RV64I-LP64F-NEXT:    ret
;
; RV32I-ILP32D-LABEL: nothing:
; RV32I-ILP32D:       # %bb.0:
; RV32I-ILP32D-NEXT:    ret
;
; RV32IF-ILP32D-LABEL: nothing:
; RV32IF-ILP32D:       # %bb.0:
; RV32IF-ILP32D-NEXT:    ret
;
; RV64I-LP64D-LABEL: nothing:
; RV64I-LP64D:       # %bb.0:
; RV64I-LP64D-NEXT:    ret
;
; RV64IF-LP64D-LABEL: nothing:
; RV64IF-LP64D:       # %bb.0:
; RV64IF-LP64D-NEXT:    ret
  ret void
}
