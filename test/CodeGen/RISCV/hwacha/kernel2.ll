...
define dso_local void @_pocl_launcher_saxpy_workgroup_fast(i8**, { i32, [3 x i64], [3 x i64], [3 x i64] }*) #1 {
  %3 = bitcast i8** %0 to float**
  %4 = load float*, float** %3, align 8
  ...
  %12 = getelementptr { i32, [3 x i64], [3 x i64], [3 x i64] }, { i32, [3 x i64], [3 x i64], [3 x i64] }* %1, i64 0, i32 2, i64 0
  %13 = load i64, i64* %12, align 8
  %14 = getelementptr { i32, [3 x i64], [3 x i64], [3 x i64] }, { i32, [3 x i64], [3 x i64], [3 x i64] }* %1, i64 0, i32 3, i64 0
  %15 = load i64, i64* %14, align 8
  call void @_pocl_launcher_saxpy(float* %4, float* %7, float %11, i32 undef, i64 undef, i64 undef, i64 undef, i64 %13, i64 undef, i64 undef, i64 %15, i64 undef, i64 undef)
  ret void
}
