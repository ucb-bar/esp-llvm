...
define dso_local void @_pocl_launcher_saxpy(half*, float*, float) {
  %idx = call i64 @llvm.hwacha.veidx() #0
  %arrayidx.i = getelementptr half, half* %0, i64 %idx
  %4 = load half, half* %arrayidx.i, align 4

  %conv.i = fpext half %4 to float
...
define dso_local void @_pocl_launcher_saxpy_workgroup(i8**, { i32, [3 x i64], [3 x i64], [3 x i64] }*) {
  %3 = bitcast i8** %0 to half***
  %4 = load half**, half*** %3, align 8
  ...
  call void @_pocl_launcher_saxpy(half* %5, float* %9, float %13)
  ret void
}
...
!2 = !{void (half*, float*, float)* @_pocl_launcher_saxpy}